...
public class HomePage {
	...
	By appStoreButton = By.xpath("//*[@class='page-scroll btn btn-primary app-store']//*[@class='btnBgSprite iStore']");
	By googlePlayButton = By.xpath("//*[@class='page-scroll btn btn-primary app-store']//*[@class='btnBgSprite playStore']");
	...
	By fbLogoInFooterSection = By.xpath("//*[@class='footer-sec']//*[@class='bgSocialIcon fb']");
