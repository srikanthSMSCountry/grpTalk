...
public class ContactsPageTest extends BrowserFunctions {
	 ...
	 * given ListName In Enter list Name field
	...
	public void verifyCreateListFromContactsPage() throws InterruptedException{
		...
		contactsPage.givenListNameInEnterlistNamefield();
		logger_ss.log(Status.INFO, "given List Name In EnterlistName field");
		boolean result=contactsPage.selectRecentlyCreatedList();
	...
	public void verifyCreateListFromContactsPageUsingPlusSymbol() throws InterruptedException{
		...
		contactsPage.enterListDetailsInAddContactTabOnOverlay();
	...
	public void verifyCreateListFromExcelUpload() throws InterruptedException, AWTException{
		...
		Utility.getUploadFile("D:\\grpTalk\\TestDataFiles\\contacts.xlsx");
		logger_ss.log(Status.INFO, "Uploaded file");
		Thread.sleep(2000);
		contactsPage.givenExcelSheetDetailsOnOverlay();
	 ...
	 * delete web list 
	 * Verify the presence of deleted web list
	 */
	@Test
	public void verifyDeleteListFromContactsPage() throws InterruptedException{
		...
		logger_ss.log(Status.INFO, "given List Name In EnterlistName field");
		contactsPage.selectRecentlyCreatedList();
		logger_ss.log(Status.INFO, "Selected Recently Created List");
	 ...
	 * select Recently Created List
	 * click drop down toggle
	 * edit/rename web list 
	 * Verify the presence of renamed web list
	 */
	@Test
	 ...
	 * select Recently Created List
	 * click drop down toggle
	 * click Add Contacts On Toggle Drop Down
	 * click add Contacts Tab On Overlay
	 * enter Details In Add Contact Tab On Overlay
	 * verify added Contact Name In List On Contact Page
	 */
	@Test
	 ...
	 * click drop down toggle
	 * click Add Contacts On Toggle Drop Down
	 * click WebList Tab On Overlay
	 * click list Group In WebList On Overlay
	 * addcontactFromWebListGroupOnOverlay
	 * verify successMsgForContactAddedToList
	 * verify addedContactNameInListOnContactPage
	 */
	@Test
	 ...
	 * add Contacts In Mobile Contacts Tab On Overlay
	 * verify successMsgForContactAddedToList
	 * verify added Contact Name In List On Contact Page
	 */
	@Test
	...
	public void tearDown(ITestResult result) throws IOException, InterruptedException {
		...
		extent.flush();
		driver.navigate().to("https://web.grptalk.com/Contacts.aspx");
		Thread.sleep(2000);
		ContactsPage contactsPage = new ContactsPage(driver);
		try{
